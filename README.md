...
1. Say As You Wish: Fine-Grained Control of Image Caption Generation With Abstract Scene Graphs   `oral` `Shizhe Chen`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/PV3fzOh4mZqtHlo.png" alt="image-20200624110722000" />
   </details>
...
2. Context-Aware Group Captioning via Self-Attention and Contrastive Features
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/3hCGHTIumn2pADK.png" alt="image-20200624112317436"/>
   </details>
...
3. More Grounded Image Captioning by Distilling Image-Text Matching Model
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/VcQltaPfYERTzCy.png" alt="image-20200624112539362"  />
   </details>
...
4. Show, Edit and Tell: A Framework for Editing Image Captions
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/EqFvH4ldBICYyOX.png" alt="image-20200624112638238" />
   </details>
...
5. Normalized and Geometry-Aware Self-Attention Network for Image Captioning
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/LSxJTzFqcaZYykO.png" alt="image-20200624112756931"/>
   </details>
...
6. Meshed-Memory Transformer for Image Captioning
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/96IbRGgmeuh4UPC.png" alt="image-20200624112920186"/>
       </details>
...
8. X-Linear Attention Networks for Image Captioning   `JD AI`
   ...
   <details>
     <summary>details</summary>
   <img src="https://i.loli.net/2020/06/24/UqOEsH1Q5PjSeTN.png" alt="image-20200624113117197" />
   </details>
...
9. Transform and Tell: Entity-Aware News Image Captioning
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/efSvYP3JGjUAwby.png" alt="image-20200624113356010" />
   </details>
...
1. ActBERT: Learning Global-Local Video-Text Representations   `oral`
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/tATPwgxdHYjbzE8.png" alt="image-20200624113926481" />
   </details>
...
2. Context-Aware Attention Network for Image-Text Retrieval
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/Ay9RU4ciqEzGfvB.png" alt="image-20200624114208609" />
   </details>
...
3. Graph Structured Network for Image-Text Matching
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/gmpOs8Znz7tIc9k.png" alt="image-20200624114356820" />
   </details>
...
4. IMRAM: Iterative Matching With Recurrent Attention Memory for Cross-Modal Image-Text Retrieval
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/qIDdyv4lo5QUVsj.png" alt="image-20200624114647836" />
   </details>
...
5. Fine-Grained **Video-Text** Retrieval With Hierarchical Graph Reasoning  `Shizhe Chen`
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/bk9YaoZ8f3GxEWl.png" alt="image-20200624114705646" />
   </details>
...
6. VIOLIN: A Large-Scale **Dataset** for Video-and-Language Inference
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/koNIgwPE3ScXpLn.png" alt="image-20200624114750147" />
   </details>
...
7. 12-in-1: Multi-Task Vision and Language Representation Learning   `Jiasen Lu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/UWGhzDTgjmM1SPu.png" alt="image-20200624150911539"  />
   </details>
...
1. Counterfactual Vision and Language Learning	`oral`
   ...
   <details>
     <summary>details</summary>
           <img src="https://i.loli.net/2020/06/24/8oONlIbC1LrEn5p.png" alt="image-20200624141414831" />
   </details>
...
5. Hierarchical Conditional Relation Networks for **Video** Question Answering   `oral`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/PgReanZD7rA1kEp.png" alt="image-20200624142033086" />
   </details>
...
6. In Defense of Grid Features for Visual Question Answering
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/KqM9UBtdfaDvwIz.png" alt="image-20200624145118917" />
</details>
...
7. VQA with No Questions-Answers Training
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/KTQkI4PeYUu6hHE.png" alt="image-20200624150753960" />
</details>
...
8. Counterfactual Samples Synthesizing for Robust Visual Question Answering
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/47vcPMLfdnpZiWm.png" alt="image-20200624151351076"  />
</details>
...
1. Multi-Task Collaborative Network for Joint Referring Expression Comprehension and Segmentation	`oral`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/S1oDIBLlYA3zyEZ.png" alt="image-20200624142136971"/>
   </details>
...
2. Graph-Structured Referring Expression Reasoning in the Wild   `oral`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/oEslgHuZLFiaNM6.png" alt="image-20200624142223347" />
   </details>
...
3. Visual-textual Capsule Routing for Text-based **Video Segmentation**  `oral`
   ...
   <details>
     <summary>details</summary>
     <img src="https://i.loli.net/2020/06/24/iwcIJ4ZqgMn1PtC.png" alt="image-20200624114543774"/>
   </details>
...
4. Bi-Directional Relationship Inferring Network for Referring Image Segmentation  `Huchuan Lu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/ZXEOyL3sWpUDJGM.png" alt="image-20200624142324261" />
   </details>
...
5. Cops-Ref: A New Dataset and Task on Compositional Referring Expression Comprehension  `Qi Wu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/F5MkXydSmebvHln.png" alt="image-20200624142428398"  />
   </details>
...
6. Referring Image Segmentation via Cross-Modal Progressive Comprehension   `Si Liu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/2DTRVkvYMlZ5XUo.png" alt="image-20200624142558684"  />
   </details>
...
7. A Real-Time Cross-Modality Correlation Filtering Method for Referring Expression Comprehension    `Si Liu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/CdZE9gUFc1vmwy3.png" alt="image-20200624142538795" />
   </details>
...
8. PhraseCut: Language-Based Image Segmentation in the Wild `Adobe` 
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/Kro8eHqcNwvEOji.png" alt="image-20200624143321558"/>
   </details>
...
1. Dense Regression Network for Video Grounding
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/3WuzlSABqYakb7g.png" alt="image-20200624150719562"  />
</details>
...
2. Video **Object Grounding** using Semantic Roles in Language Description   `Arka Sadhu`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/nNgj2xdX8mhvZMc.png" alt="image-20200624150839459" />
</details>
   
3. Where Does It Exist: Spatio-Temporal Video Grounding for Multi-Form Sentences   `Alibaba`

   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/YRVrZGI9wLXyubP.png" alt="image-20200624151008319"/>
</details>
...
4. Local-Global Video-Text Interactions for Temporal Grounding
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/Ml9CuNmLjgow1de.png" alt="image-20200624151503579"  />
</details>
...
5. Visual Grounding in Video for Unsupervised Word Translation
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/6Y3veb81MxUq9Vw.png" alt="image-20200624151551261" />
</details>
...
2. REVERIE: Remote Embodied Visual **Referring Expression** in Real Indoor Environments   `oral` `Peter Anderson Qi Wu, William Yang Wang`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/anflN3q16rYhA5C.png" alt="image-20200624142835921"  />
   </details>
...
3. Towards Learning a Generic Agent for Vision-and-Language Navigation via Pre-training
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/RNZ51Y69zIVLCuc.png" alt="image-20200624152242793" />
   </details>
...
1. Iterative Context-Aware Graph Inference for Visual Dialog  `oral`	`Zheng-jun Zha`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/cJiCygXLH7lfsPz.png" alt="image-20200624142940560" />
   </details>
...
2. Vision-Dialog Navigation by Exploring Cross-modal Memory
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/ID6nEHmeocV9YQi.png" alt="image-20200624151115660" />
   </details>
...
3. Two Causal Principles for Improving Visual Dialog   `Hanwang Zhang`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/aUfkltMhgVIXunT.png" alt="image-20200624151646066" />
   </details>
...
1. Unbiased Scene Graph Generation From Biased Training	`oral` `Hanwang Zhang`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/qtPg2c5TYsU7CuQ.png" alt="image-20200624152538766" />
   </details>
...
2. GPS-Net: Graph Property Sensing Network for Scene Graph Generation	`oral` `Dacheng Tao`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/Cm8QqNYBPtKIXTU.png" alt="image-20200624152642647"  />
   </details>
...
1. Visual Commonsense R-CNN	`Hanwang Zhang`
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/h6P9krYUAC8FlOE.png" alt="image-20200624151255181" \ />
   </details>
...
2. Straight to the Point: Fast-forwarding Videos via Reinforcement Learning Using Textual Data
   ...
   <details>
     <summary>details</summary>
       <img src="https://i.loli.net/2020/06/24/pYanON4Tmx7EWGJ.png" alt="image-20200624151933970" />
   </details>
